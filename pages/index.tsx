...
export default function Home() {
  type PropsDeposit = { depositData: Deposit[] };
  type PropsWithdrawal = { depositData: Withdrawal[] };
  type PropsTradeOrder = { depositData: TradeOrder[] };
  ...
  async function GetServerSideProps() {
    ...
    return { props: { deposits, withdrawals, tradeOrders } };
  }
